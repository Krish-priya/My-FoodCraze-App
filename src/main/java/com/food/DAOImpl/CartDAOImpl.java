...
public class CartDAOImpl implements CartInterface {
    ...
    public void addCartItem(CartModel cart) {
    	...
    	String sql =
    		    "INSERT INTO cart(menuId,restaurantId, menuName, price, quantity, imageUrl) VALUES (?,?, ?, ?, ?, ?)";
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            ps.setString(3, cart.getMenuName());
            ps.setDouble(4, cart.getPrice());
            ps.setInt(5, cart.getQuantity());
            ps.setString(6, cart.getImageUrl());
    ...
    public List<CartModel> getAllCartItems() {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                cart.setRestaurantId(rs.getInt("restaurantId"));
